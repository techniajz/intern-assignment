...
//     let countryrr = await Countries.find({}).lean();
//     async.mapSeries(countryrr, (countryIdd, callback) => {
//             states.map(async state => {
//                 if(countryIdd.country_id == state.country_id){
//                     let stateObj = {};
//                     stateObj.stateName = state.name;
//                     stateObj.countryId =countryIdd._id;
//                     await new State(stateObj).save();
//                 }
//             })
//         callback();
//     });
